...
REQUIRED_CONFIGS = [
    ...
    ("ENABLE_PERSONAL_OVERFLOW", "启用 Team exhausted 后切换到 Personal/free（true/false）", "false", True),
    ("SYNC_PERSONAL_TO_CPA", "同步 Personal/free 认证到 CPA（true/false）", "false", True),
    ("SYNC_PERSONAL_TO_SUB2API", "同步 Personal/free 认证到 Sub2API（true/false）", "false", True),
